...
*/}
  ...
  {/* <div className="mobileApp_Download">
    ...
    <div className="app_rating">
      <div className="d-flex align-items-center">
        ...
        <div className="appdwnlds">
          <h2>Al Maqam App</h2>
          <div className="d-flex appStar">
            {" "}
            <img src="images/app_star.png" />
    ...
    <div className="appdwnldList">
      <ul>
        <li>
          {" "}
          <i className="speedbookicon" /> Speed up bookings with saved details
        </li>
        <li>
          {" "}
          <i className="speedbookicon" /> Get instantly notified about new
          offers
        </li>
        <li>
          {" "}
          <i className="speedbookicon" /> Earn rewards &amp; collect points{" "}
        </li>
      </ul>
    </div>
    <button className="theme_button dwnloadBtn">Download App</button>
  </div> */}
      ...
      <section className="search_are_outer">
        ...
        <div className="search_area">
          <div className="search_area_topnav">
            <ul>
              <li>
                <a className="tab-links umrah_package_click active" href="#">
                  {" "}
           ...
           <FlightSearch/>
              ...
              <div className="search_field_main hotel_search">
                <div className="search_field_lft">
                  <div className="field_row">
                    ...
                    <div className="field_clm_3 field_clm_3_psngr HmHotelTravel">
                      <div className="form-group  down_arrow">
                        ...
                        <input
                          ...
                          name=""
                          id="from_city"
                          placeholder="1 Guests, 1 Room"
                          className=" "
                        />
                      </div>
                      <div
                        className="psngerBox"
                        id="hoteltrvlersClass"
                        style={{ display: "none" }}
                      >
                        <button type="button" className="close" />
                        <div className="room-repeat">
                          <h3>Room 1</h3>
                          <ul>
                            <li>
                              <div className="form-group down_arrow">
                        ...
                        <div className="d-flex flex-wrap justify-content-between mb-2 mt-2">
                          {" "}
                          <span className="addRoom">+ Add Room</span>{" "}
                          <span className="removeRoom">- Remove Room</span>{" "}
                        </div>
            ...
            <div className="activity_panel" style={{ display: "none" }}>
              <div className="search_field_main activity_search">
                <div className="search_field_lft">
                  <div className="field_row">
                    <div className="field_clm_3_activity">
                      <div className="form-group location_icon">
            ...
            <div className="item">
              <div className="hmumrahpackBox">
                ...
                <div className="d-flex hm_packPlace">
                  {" "}
                  <span>Makkah(4N)</span> <span className="hmspace"> | </span>{" "}
                  <span> Madinah(3N)</span>{" "}
                </div>
                <div className="d-flex hmpackcity">
                  <div className="hmDepartCityDate">
                    {" "}
                    <span className="w-100"> Departure City: Dubai </span>{" "}
                    <span className="w-100"> Departure Date: 15 Jul 2023 </span>{" "}
                  </div>
                ...
                <div className="item">
                  <div className="hmumrahpackBox">
                    <div className="d-flex hm_packpadd">
                      <div className="pack_thumb">
                        {" "}
                        <img src="images/trending_htl01.jpg" alt="deals" />{" "}
                      </div>
                      <div className="pack_Dtls">
                    ...
                    <div className="hmpackPriceBox">
                      ...
                      <div className="d-flex justify-content-between align-items-end">
                        <div className="hmpackShare">
                          <button className="theme_button"> Book Now </button>
                        </div>
                        <div className="hmUmrahPackPrice custPackagePrice">
                          <p>Starts from</p>
                          <h3>AED 80.00</h3>
                ...
                <div className="item">
                  <div className="hmumrahpackBox">
                    <div className="d-flex hm_packpadd">
                      <div className="pack_thumb">
                        {" "}
                        <img src="images/trending_htl02.jpg" alt="deals" />{" "}
                      </div>
                      <div className="pack_Dtls">
                        <div className="hmHtlStar fourstar"> </div>
                        <p>Atlantis, The Palm</p>
                ...
                <div className="item">
                  <div className="hmumrahpackBox">
                    <div className="d-flex hm_packpadd">
                      <div className="pack_thumb">
                        {" "}
                        <img src="images/trending_htl03.jpg" alt="deals" />{" "}
                      </div>
                      <div className="pack_Dtls">
                        <div className="hmHtlStar fourstar"> </div>
                        <p>Atlantis, The Palm</p>
                ...
                <div className="hmtrendflDtls d-flex flex-wrap justify-content-between align-items-center">
                  <div className="hmtrendflLeft">
                    <div className="trendfl_country">
                      <span> Dubai </span> <span className="fldoublearrow" />{" "}
                      <span>Kuwait</span>{" "}
                    </div>
                    <p>Starts from</p>
                    <h2>AED 157.00</h2>
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-lg-12 text-center trustpilot">
          <p>
            Rated 4.9/5 based on <span>6511 reviews.</span> Showing our 4&amp;5
            star reviews.
          </p>
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-lg-4 col-md-4 text-center">
          ...
          <p>
            We Are Always Negotiating With Airline Companies to Get You The Best
            Prices
          </p>
        </div>
        <div className="col-lg-4 col-md-4 text-center">
        ...
        <div className="col-lg-4 col-md-4 text-center">
          ...
          <p>
            Around the clock customer service &amp; Support is available By Live
            chat, Phone &amp; E-mail
          </p>
        </div>
      </div>
        ...
        <div className="col-lg-12">
          ...
          <div className="hm_newsLetter">
            ...
            <form className="form-inline d-flex">
              ...
              <button type="submit" className="theme_button hm_subscribeBtn">
                Subscribe
              </button>
            </form>
          </div>
                        ...
                        <div className="col-lg-3 col-6 p-0">
                          <div className="foot_seolisting">
                            ...
                            <a href="#" className="viewMore">
                              View More <img src="images/viewMore_Arrow.png" />{" "}
                            </a>{" "}
                          </div>
                        </div>
                        <div className="col-lg-3 col-6 p-0">
  ...
  <footer>
    <div className="container mobhide">
      <div className="row m-0">
        {/*<div class="col-lg-3 col-md-6 p-0">
  <div class="foot_list">
    <h2>Umrah Packages</h2>
    <ul>
      <li><a href="#">Deluxe Umrah Package 2023</a></li>
      <li><a href="#">Umrah Package 21 Days</a></li>
      <li><a href="#">Economy Umrah Package</a></li>
      <li><a href="#">Religious Pilgrimage</a></li>
      <li><a href="#">Makkah & Madina Tour Package</a></li>
      <li><a href="#">7 Nights Umrah Package</a></li>
    </ul>
  </div>
</div>*/}
    ...
    <div className="foot_bottom">
      <div className="container">
        <div className="d-flex justify-content-center">
          {" "}
          <img src="images/orientTravel_logo.png" />{" "}
        </div>
        <div className="d-flex justify-content-center">
          <p> © 2024 Maqam. Powered by Orient Travel</p>
        </div>
      </div>
    </div>
  </footer>
          ...
          <div className="login_view">
            ...
            <div className="user_info theme_radius">
              ...
              <p>
                ...
                quicker bookings and manage your upcoming bookings with ease!
              </p>
            </div>
  ...
  {/* Login Case */}
  {/* Register Case */}
  <div className="SideModalnew modal right fade" id="register" role="dialog">
    <div className="modal-dialog">
      {/* Modal content*/}
      <div className="modal-content">
        <div className="modal-header">
            ...
            <div className="field_carton">
              <div className="registerForm_box w-100">
                <form>
                  ...
                  <div className="form-group">
                    <label htmlFor="exampleInputmail">Email address</label>
                    <input
                      type="mailbox"
                      className="form-control"
                      id="exampleInputmail"
            ...
            <div className="field_carton">
              <div className="registerForm_box w-100">
                <form>
                  ...
                  <div className="form-group">
                    <label htmlFor="exampleInputmail">Destination</label>
                    <input
                      type="mailbox"
                      className="form-control"
                      id="exampleInputmail"
                  ...
                  <div className="form-group">
                    <label htmlFor="exampleInputmail">Date of Travel </label>
                    <input
                      type="mailbox"
                      className="form-control"
                      id="exampleInputmail"
                  ...
                  <div className="form-group">
                    <label htmlFor="exampleInputmail">Descript/Remarks </label>
                    <textarea
